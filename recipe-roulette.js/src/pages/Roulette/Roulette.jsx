...
export function Roulette() {
  ...
  if (showTutorial) {
    return (
      <>
        {createPortal(
          <Tutorial checkbox={true} setShowTutorial={setShowTutorial} />,
          document.querySelector(".appContainer > .centerContent"),
        )}
      </>
    );
      ...
      <div className={`${layout.pageFH} ${layout.noVerticalPadding}`}>
        <div>
          ...
          <div className={searchWrapper.globalActions}>
            ...
            <IcoButton
              action={() => deselectIngredients("is_selected")}
              icon={<LockResetIcon fontSize={"small"} />}
            />
            <IcoButton
              action={() => setPrefSidebar((b) => !b)}
