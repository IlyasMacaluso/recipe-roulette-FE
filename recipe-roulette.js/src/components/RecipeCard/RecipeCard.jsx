    ...
    >
      <div className={classes.topItems}>
        <div
          ...
          className={`${classes.favIcon} ${!cardState.is_favorited ? classes.notFav : classes.isFav}`}
        >
          <FavoriteIcon
            stroke={"#e5e0df"}
            strokeWidth={cardState.is_favorited ? "0" : "1px"}
          />
        </div>
      ...
      {expandedCard && (
        <div className={classes.recipeBody}>
          ...
          >
            ...
            <ul>
              {ing_quantities.length > 0 &&
                ing_quantities.map((ingredient, index) => {
