...
export function Sidebar({ removeBgOverlay = false, showBlacklist = false, filtersName = "recipeFilters" }) {
    const { deselectIngredients, ingredients, blacklistedLoading, blacklistedError } = useManageIngredients()
    ...
    const { updateFilters, deselectFilters, setRecipeFilters, setRecipePreferences, recipeFilters, recipePreferences, foodPrefError } =
        useRecipesContext()
    ...
    const sidebarState = filtersName === "recipeFilters" ? filterSidebar : prefSidebar
